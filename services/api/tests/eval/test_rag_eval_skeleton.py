...
EVAL_CASES: list[tuple[str, str, str]] = [
    ("pgvector-hnsw", "Which HNSW params worked well for the pgvector dataset?", "m=16"),
    ("kitchen-reno", "What sink did I shortlist for the kitchen?", "Kraus"),
    ("aiogram3-reasoning", "Why did Mnemo pick aiogram 3?", "FSM"),
    ("rrf-adr", "What k value does Mnemo's RRF use?", "60"),
    ("rag-citation", "How does Mnemo cite a source in answers?", "short id"),
]
...
def test_rag_eval(seed: str, question: str, expected: str) -> None:
